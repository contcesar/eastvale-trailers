...
| **Business name, address, hours** | `src/data/business.js` |
| **Production URL** | `site` in `astro.config.mjs`, `url` in `src/data/business.js`, and `public/robots.txt` |
| **Logo** | `src/components/Header.astro` (text logo) and `public/favicon.svg` |
| **Hero photo** | `public/images/hero.jpg`, referenced in `src/pages/index.astro` |
